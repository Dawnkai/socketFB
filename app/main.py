...
class ProfileScreen(Screen):
    ...
    def sendMessage(self):
        ...
        data = {"sender": username, "receiver": self.ids["drop_item"].text, "content": self.ids["fr_chat_msg"].text}
        print(f"send {data}")
...
class AddFriendScreen(Screen):
    ...
    def addFriend(self):
        ...
        elif buff == b'401 : Friend already added.':
            self.ids["add_info"].text = "This user is already your friend."
            self.ids["add_info"].color = (0.75,0.75,0)
